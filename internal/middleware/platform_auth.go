...
import (
	...
	"iag-ai-platform/backend/internal/ctxkeys"
)
...
// Caller returns a stable identifier for the principal making the request,
// used to attribute AI usage. Service tokens are attributed by client_id;
// users by "user:<subject>".
